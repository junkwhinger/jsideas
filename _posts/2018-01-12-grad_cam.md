...
author:     "Jun"
categories: "Python"
image: /assets/Grad_CAM/resnet50_guided_grad_cam.png
---
...
![CAM Architecture](/assets/Grad_CAM/cam_architecture.png)
...
![CAM vs. Grad-CAM](/assets/Grad_CAM/cam_vs_grad_cam.png)

## Grad-CAM: Implementation

귀여운 고양이와 ResNet50 pretrained 모델로 구현 방법을 살펴보자.

![귀여운 고양이](/assets/Grad_CAM/cat.jpg)
...
![ResNet50 - CAM & Grad-CAM](/assets/Grad_CAM/cat_cam.png)
...
![VGG16 - Grad-CAM](/assets/Grad_CAM/vgg_grad_cam.png)
...
![ResNet50 - Grad-CAM](/assets/Grad_CAM/resnet.gif)
...
![Grad-CAM Architecture](/assets/Grad_CAM/grad-cam_architecture.png)
...
![guided backpropagation](/assets/Grad_CAM/guided_backpropagation.png)
...
![deconvnet](/assets/Grad_CAM/backprop.png)


2) deconvnet

![deconvnet](/assets/Grad_CAM/deconvnet.png)


3) guided backpropagation

![guided backpropagation](/assets/Grad_CAM/guidedbackprop.png)
...
![guided backpropagation - Egyption Cat](/assets/Grad_CAM/guidedbackprop.png)
...
![Guided Grad-CAM](/assets/Grad_CAM/guided_grad_cam.png)
...
![ResNet50: CAM](/assets/Grad_CAM/resnet50_cam.png)

2) Grad-CAM + bounding box

![ResNet50: Grad-CAM](/assets/Grad_CAM/resnet50_grad_cam.png)

3) CAM, Grad-CAM, Guided Grad-CAM

![ResNet50: Grad-CAM](/assets/Grad_CAM/resnet50_guided_grad_cam.png)
