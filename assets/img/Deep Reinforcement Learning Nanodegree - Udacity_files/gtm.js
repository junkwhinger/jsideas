...
"resource": {
  ...
  "rules":[
    [["if",0],["add",0,5,6,12,20,29,32,37,38,47,71,77,81,82,85]],
    [["if",1],["add",0]],
    [["if",2],["add",1,5,7,21,83]],
    [["if",3,4],["add",2,3,4,42]],
    [["if",3,5],["add",3,9,43]],
    [["if",5,6],["add",3,9,44]],
    [["if",4],["add",5,8]],
    ...
    [["if",12],["add",13]],
    [["if",13],["add",13]],
    [["if",14,15],["add",14,15,50,52,27,28]],
    [["if",15,16],["add",16,51,53]],
    [["if",5,17],["add",17,19,59]],
    [["if",0,18],["add",17,19,59,62]],
    [["if",5,19,20],["add",18,59]],
    [["if",0,21],["add",18,19,59,63]],
    [["if",5,22],["add",19,61]],
    [["if",5,23],["add",22,84]],
    [["if",0,24],["add",23,45,46,64,65,54,55]],
    [["if",25,26],["add",24,25,30,31,68,72,73,74,75,76,79,86]],
    [["if",25,26,27],["add",26]],
    [["if",5],["add",33,39,40,69,78,80,36]],
    [["if",5,8],["add",34]],
    [["if",5,28],["add",35]],
    [["if",5,29],["add",37]],
    [["if",5,30],["add",41]],
    [["if",5,31],["add",46,49,60,61,64]],
    [["if",32,33],["add",46,64]],
    [["if",5,34],["add",48]],
    [["if",5,35],["add",54,61]],
    [["if",33,36],["add",54]],
    [["if",5,37],["add",56]],
    [["if",5,38],["unless",39],["add",57]],
    [["if",5,40],["add",58]],
    [["if",5,41],["add",61]],
    [["if",5,42],["add",61]],
    [["if",5,43],["add",61]],
